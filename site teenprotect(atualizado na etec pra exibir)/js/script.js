...
if(window.location.pathname == '/denuncia'){
    console.log("ai")
        ...
        //arrumar esta parte depois 
        const rotaAtual = window.location.pathname;

        switch(rotaAtual){
            case "/":
                console.log("pagina home iniciada");
            break;
            case "/login":
                console.log("pagina login iniciada");
            break;
            case "/cadastro":
                console.log("pagina cadastro iniciada");
            break;
            case "/denuncia":
                console.log("pagina denuncia iniciada");
            break;
            case "/contato":
                console.log("pagina contato iniciada ");
            break;
        }

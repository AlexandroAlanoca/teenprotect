...
if (isset($_FILES["IMG"]) && $_FILES["IMG"]["error"] == UPLOAD_ERR_OK) {
    ...
    $tipoMime = mime_content_type($_FILES["IMG"]["tmp_name"]);
    ...
    $nomeArquivo = uniqid("IMG", true) . "." . $extensao;
    ...
    if (move_uploaded_file(
        ...
        $evidencia = "../../uploadImg/" . $nomeArquivo;
...
*/
  ...
  //-------------------
    $sql = "INSERT INTO denuncias
            (usuario_id, protocolo, tipo_denuncia, descricao, data_ocorrido, IMG)
            VALUES (?, ?, ?, ?, ?, ?, ?)";

...
document.addEventListener("click", (event) => {
    // Verifica se o clique foi fora do #dropLeft e do #dropContent
    if (
        !dropLeft.contains(event.target) &&
...
function atualizarPosicao() {
    const rect = dropLeft.getBoundingClientRect();

    dropContent.style.top = rect.top + "px";
    console.log("rolando")
}

menuScroll.addEventListener("scroll", atualizarPosicao);
...
//------efeito hover no switch theme
const radioSwitch1 = document.getElementById("radio-switch1")
const radioSwitch2 = document.getElementById("radio-switch2")
const radioSpan1 = document.getElementById("radio-span1")
const radioSpan2 = document.getElementById("radio-span2")

radioSwitch1.addEventListener("mouseover", function() {
    radioSpan1.style.opacity = "0.75";
});

radioSwitch2.addEventListener("mouseover", function() {
    radioSpan2.style.opacity = "0.75";
});

radioSwitch1.addEventListener("mouseout", function() {
    radioSpan1.style.opacity = "";
});

radioSwitch2.addEventListener("mouseout", function() {
    radioSpan2.style.opacity = "";
});
//------efeito hover no switch language
const radioSwitchLang1 = document.getElementById("radio-switch-lang1")
const radioSwitchLang2 = document.getElementById("radio-switch-lang2")
const radioSwitchLang3 = document.getElementById("radio-switch-lang3")
const radioSpanLang1 = document.getElementById("radio-span-lang1")
const radioSpanLang2 = document.getElementById("radio-span-lang2")
const radioSpanLang3 = document.getElementById("radio-span-lang3")

radioSwitchLang1.addEventListener("mouseover", function() {
    radioSpanLang1.style.opacity = "0.75";
});

radioSwitchLang2.addEventListener("mouseover", function() {
    radioSpanLang2.style.opacity = "0.75";
});

radioSwitchLang3.addEventListener("mouseover", function() {
    radioSpanLang3.style.opacity = "0.75";
});

radioSwitchLang1.addEventListener("mouseout", function() {
    radioSpanLang1.style.opacity = "";
});

radioSwitchLang2.addEventListener("mouseout", function() {
    radioSpanLang2.style.opacity = "";
});

radioSwitchLang3.addEventListener("mouseout", function() {
    radioSpanLang3.style.opacity = "";
});

//botao login e cadastro desabilitados quando usuario estiver logado
if(localStorage.getItem("logado") === "true"){
    document.getElementsById("loginBt").style.display = "none";
    document.getElementsById("cadastroBt").style.display = "none";
    document.getElementsById("loginBt").style.display = "none";
...
fetch("verificar_login.php")
    ...
    .then(data => {
        if(data.logado){
            ...
            document.getElementById("cadastroBt").style.display = "none";
           //document.getElementById("logoutBt").style.display = "block";

            document.getElementById("nomeUsuario").textContent = data.nome;
            document.getElementById("nomeUsuario").style.display = "block";
            document.getElementById("dropLeft").style.display = "flex";
        }else{
            document.getElementById("loginBt").style.display = "block";
            document.getElementById("cadastroBt").style.display = "block";
            //document.getElementById("logoutBt").style.display = "none";

            document.getElementById("nomeUsuario").textContent = '';
            document.getElementById("nomeUsuario").style.display = "none";
            document.getElementById("dropLeft").style.display = "none";
        }
    })

const usuarioBt = document.querySelector(".menu-buttons")
const logoutBt = document.querySelector("#dropContent")
if(usuarioBt){
    usuarioBt.addEventListener("click", () => {
        if (logoutBt.style.display === 'none') {
            logoutBt.style.display = "flex";
        } else {
            logoutBt.style.display = "none";
        }
        console.log("a")//arrumar posicao do botao sair 
    });
};
...
const traducoes = {
    ...
    pt: {
        title: "O que é o aliciamento nas mídias sociais?",
    ...
    es: {
        ...
        text: "La captación en las redes sociales ocurre cuando alguien utiliza plataformas digitales para ganarse la confianza de otra persona con el fin de manipularla, explotarla o involucrarla en actividades dañinas. Este proceso suele ser gradual. El seductor puede hacerse pasar por alguien de confianza, crear vínculos emocionales y, poco a poco, inducir a la víctima a tomar decisiones que pueden ponerla en peligro.",
        title2: "Como sucede?",
        text2: "La captación suele seguir algunos patrones:",
        textLi1: "Contacto inicial amistoso: el agresor inicia una conversación de forma aparentemente inocente;",
        textLi2: "Creación de confianza: muestra interés, atención y apoyo emocional;",
        textLi3: "",
        textLi4: "",
        textLi5: "",
        title3: "",
